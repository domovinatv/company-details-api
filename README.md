...
dohvaća poslovne podatke i **razvrstava poduzetnike po veličini** —
**mikro / mali / srednji / veliki** — prema Zakonu o računovodstvu (NN 85/24,
čl. 5). Za **udruge** ne računa kategoriju veličine nego prati **ima li
zaposlenih i koliko**.
...
# 6) Obogati + razvrstaj (Firecrawl; troši kredite — počni s malim brojem)
npm run bridge:enrich -- --limit 10
```
